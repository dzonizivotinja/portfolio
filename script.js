        ...
        window.tram = function(e) {
            ...
            var d = function(l, E, T) {
                ...
                g = {
                    ease: ["ease", function(l, E, T, I) {
                        var m = (l /= I) * l,
                            A = m * l;
                        return E + T * (-2.75 * A * m + 11 * m * m + -15.5 * A + 8 * m + .25 * l)
                    }],
                    ...
                    "ease-out": ["ease-out", function(l, E, T, I) {
                        var m = (l /= I) * l,
                            A = m * l;
                        return E + T * (.3 * A * m + -1.6 * m * m + 2.2 * A + -1.8 * m + 1.9 * l)
                    }],
            ...
            var P = t.frame = function() {
                ...
                j = d(function(l) {
                        ...
                        if (Q) {
                            ...
                            if (le == "object") {
                                ...
                                Ze.call(this, Q, function(Te, G_) {
                                    ...
                                    duration: Ce,
                                    context: this
                                }), this.active = !0, se && (this.timer.complete = A));
                                var We = this,
                                    qe = !1,
                                    en = {};
                                P(function() {
                    ...
                    }, He("add", E), He("start", T), He("wait", I), He("then", m), He("next", A), He("stop", K), He("set", re), He("show", pe), He("hide", G), He("redraw", ne), He("destroy", ae)
                }),
                D = d(j, function(l) {
                    function E(T, I) {
                ...
                M = d(function(l) {
                    ...
                    l.init = function(A, K, re, pe) {
                        ...
                        A = this.convert(A, this.type), this.auto && (K == "auto" && (K = this.convert(this.get(), this.type)), A == "auto" && (A = E.call(this))), this.tween = new Z({
                            from: K,
                            to: A,
                        ...
                        var re, pe = typeof A == "number",
                            G = typeof A == "string";
                        switch (K) {
                            case O:
                                if (pe) return A;
                                if (G && A.replace(x, "") === "") return +A;
                                re = "number(unitless)";
                                break;
                            case R:
                                if (G) {
                                    if (A === "" && this.original) return this.original;
                                    if (K.test(A)) return A.charAt(0) == "#" && A.length == 7 ? A : I(A)
                                }
                ...
                oe = d(M, function(l, E) {
                    function T(I, m) {
                        var A, K, re, pe, G;
                        for (A in I) pe = ve[A], re = pe[0], K = pe[1] || A, G = this.convert(I[A], re), m.call(this, K, G, re)
                    }
                    l.init = function() {
                        ...
                        return T.call(this, I, function(K, re, pe) {
                            A[K] = re, this.current[K] === void 0 && (m = 0, ~K.indexOf("scale") && (m = 1), this.current[K] = this.convert(m, pe))
                        }), A
                    }
                }),
                Z = d(function(l) {
                    ...
                    l.init = function(G) {
                        ...
                        if (ae < this.duration) {
                            ...
                            return ne = this.startRGB ? A(this.startRGB, this.endRGB, _e) : m(this.begin + _e * this.change), this.value = ne + this.unit, void this.update.call(this.context, this.value)
                        }
                ...
                ut = d(Z, function(l, E) {
                    l.init = function(T) {
                        ...
                        var I, m, A = this.tweens.length,
                            K = !1;
                        for (I = A; I--;) m = this.tweens[I], m.context && (m.render(T), this.current[m.name] = m.value, K = !0);
            ...
            U.transform && (H.transform = [oe], ve = {
                ...
                skewX: [V],
                skewY: [V]
            }), U.transform && U.backface && (ve.z = [w, "translateZ"], ve.rotateZ = [V], ve.scaleZ = [O], ve.perspective = [C]);
            var xt = /ms/,
                ct = /s|\./;
            return e.tram = t
        }(window.jQuery)
...
` + ee + "}", j
    ...
    var Hs = u((NH, Vs) => {
        ...
        Ni.define("edit", Vs.exports = function(e, t, r) {
            ...
            function S(R) {
                ...
                var w = function(V) {
                    V.data === "WF_third_party_cookies_unsupported" ? (O(C, w), R(!1)) : V.data === "WF_third_party_cookies_supported" && (O(C, w), R(!0))
                };
                C.onerror = function() {
                    O(C, w), R(!1)
        ...
        eT.define("focus-visible", Ws.exports = function() {
            function e(r) {
                ...
                function c(O) {
                    var R = O.type,
                        C = O.tagName;
                    return !!(C === "INPUT" && a[R] && !O.readOnly || C === "TEXTAREA" && !O.readOnly || O.isContentEditable)
                }
                ...
                function S(O) {
                    O.target.nodeName && O.target.nodeName.toLowerCase() === "html" || (n = !1, x())
                }
    ...
    var yv = u((tB, Ev) => {
        ...
        function uN(e, t, r, n, i, o) {
            ...
            for (var N = a; ++d < c;) {
                ...
                var x = e[g],
                    S = t[g];
                if (n) var O = a ? n(S, x, g, t, e, o) : n(x, S, g, e, t, o);
                if (!(O === void 0 ? x === S || i(x, S, r, n, o) : O)) {
                    _ = !1;
                    break
                }
                N || (N = g == "constructor")
    ...
    var ii, vt, ED, yD, mD, _D, TD, bD, ni, iE, ID, OD, Wa, AD, xD, SD, wD, oE, aE = he(() => {
        ...
        ii = ue(Dt()), vt = ue(jt()), {
            ...
            if (r && n) {
                ...
                if (O < 0) return e;
                let R = ni(Math.min(Math.max(0, O / N), 1)),
                    C = iE(_, R, h),
                    w = {},
                    V = null;
            ...
            [dV]: {
                ...
                handler: ({
                    ...
                    let {
                        ...
                        pageX: h = o.pageX,
                        pageY: y = o.pageY
                    } = n, _ = s === "X_AXIS", N = n.type === "mouseout", x = p / 100, S = c, O = !1;
                    switch (a) {
                        case nt.VIEWPORT: {
                    ...
                    return N && (x > 1 - Vm || x < Vm) && (x = Math.round(x)), (a !== nt.ELEMENT || O || O !== o.elementHovered) && (x = f ? 1 - x : x, e.dispatch(fr(S, x))), {
                        elementHovered: O,
                        clientX: d,
                        clientY: g,
                        pageX: h,
    ...
    function iH({
        ...
        GV(h, i) && (S = UV(t, S));
        let O = p.hasBoundaryNodes && r ? Yr(r, yi) : null;
        x.forEach(R => {
            let {
                keyframe: C,
                actionItems: w
    ...
    function dH({
        ...
        (0, vr.default)(s, (d, g) => {
            ...
            XV(N, o.mediaQueryKeys) || t.dispatch(ns()), y.actionTypeId === Ve.GENERAL_CONTINUOUS_ACTION && (Array.isArray(h.config) ? h.config : [h.config]).forEach(O => {
                let {
                    continuousParameterGroupId: R
                } = O, C = (0, gt.default)(a, `${x}.continuousParameterGroups`, []), w = (0, i_.default)(C, ({
                    id: k
                }) => k === R), V = (O.smoothing || 0) / 100, X = (O.restingState || 0) / 100;
                w && d.forEach((k, Y) => {
                    let te = _ + ys + Y;
                    iH({
                        store: t,
    ...
    function Jr({
        ...
        let O = f.hasBoundaryNodes && r ? Yr(r, yi) : null,
            R = qV(S),
            C = !1;
    ...
    function Ts(e) {
        let {
            ...
            refState: x
        } = h[N] || {}, S = ss(i), O = y.reducedMotion && Xo[o.actionTypeId], R;
        if (O && c) switch (_.events[p]?.eventTypeId) {
            case Ye.MOUSE_MOVE:
    ...
    var x_ = u((Gj, A_) => {
        ...
        gr.define("links", A_.exports = function(e, t) {
            ...
            function N(x, S, O) {
                var R = x.hasClass(S);
                O && R || !O && !R || (O ? x.addClass(S) : x.removeClass(S))
            }
            return r
        })
    });
                ...
                function g(N) {
                    if (a) {
                        ...
                        var x = N.touches,
                            ...
                            O = S - p;
                        p = S, Math.abs(O) > c && r && String(r()) === "" && (i("swipe", N, {
    ...
    var P_ = u((Wj, L_) => {
        ...
        Ai.define("forms", L_.exports = function(e, t) {
            ...
            function S() {
                c = e("html").attr("data-wf-site"), y = "https://webflow.com/api/v1/form/" + c, a && y.indexOf("https://webflow.com") >= 0 && (y = y.replace("https://webflow.com", "https://formdata.webflow.com")), _ = `${y}/signFile`, i = e(s + " form"), i.length && i.each(O)
            }
            ...
            function U(P, W) {
                ...
                function l(m) {
                    var A = m.responseJSON && m.responseJSON.msg,
                        K = xt;
                    typeof A == "string" && A.indexOf("InvalidFileTypeError") === 0 ? K = ve : typeof A == "string" && A.indexOf("MaxFileSizeError") === 0 && (K = H), ce.text(K), Z.removeAttr("data-value"), Z.val(""), $.toggle(!1), M.toggle(!0), oe.toggle(!0), oe.focus(), W.fileUploads[P].uploading = !1, I() || C(W)
                }
        ...
        At.define("navbar", q_.exports = function(e, t) {
            ...
            function de(v, F) {
                ...
                var ve = ut(v),
                    ...
                    l = v.el.height(),
                    E = v.el[0];
                if (M(0, E), O.intro(0, E), At.redraw.up(), f || o.on("click" + h, v.outside), F) {
                    m();
                    return
                }
            ...
            function ce(v, F) {
                ...
                var z = v.config;
                if ((z.animation === "none" || !n.support.transform || z.duration <= 0) && (F = !0), O.outro(0, v.el[0]), o.off("click" + h, v.outside), F) {
                    n(v.menu).stop(), E();
                    return
                }
...
Webflow.require('ix2').init({
    "events": {
        "e": {
            ...
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|1ad5b505-5e50-fc1a-1678-af7a1a34cc17",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-3": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|863abda3-3c45-7a51-1c33-a72a447f5f86",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-5": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|80fb09b8-482d-5ca4-15f7-5e1409803d85",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-7": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|4552b201-1cd0-510c-3aee-f41be1f9a58e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-11": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|fc2410b9-327e-cd56-036b-89b3e1def90f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-13": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|9948a845-e92d-26e9-3c95-d99df2af5c5b",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-15": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|b6a038c2-cfa3-d899-14f4-9b6a261804a9",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-17": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|ddf545d7-7a17-ac81-d317-70836b344401",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-19": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|769cfbb3-c792-b806-6dda-1109faa4ebce",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-21": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|9ee45943-5515-2d5d-25f8-f38fe700d5db",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-25": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|28b7e034-82ba-89c4-cdad-e1270bdb8efd",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-27": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|58f0a867-f58c-c0b7-e743-2e8d0d945a90",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-29": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|58f0a867-f58c-c0b7-e743-2e8d0d945a8f",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-31": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|6376ee76-604c-47ad-5a4f-3b0ec82c46fe",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-33": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|6e1f5abc-fa5e-0e5c-e6eb-280d15a9945c",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-35": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "selector": ".work-link-block",
                "originalId": "64cd3c3c7105a169a5b597f1|3d9c098f-84eb-17e8-945d-7d70a25e8fdf",
                "appliesTo": "CLASS"
            },
            "targets": [{
                "selector": ".work-link-block",
        ...
        "e-37": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|71b3c46a-69bb-9ea3-9100-51ce00cbb26e",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-39": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|755e9f57-913f-0fb8-d70d-e8f71853eef8",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
        ...
        "e-41": {
            ...
            "mediaQueries": ["main", "medium", "small", "tiny"],
            "target": {
                "id": "64cd3c3c7105a169a5b597f1|755e9f57-913f-0fb8-d70d-e8f71853eef9",
                "appliesTo": "ELEMENT",
                "styleBlockIds": []
            },
            "targets": [{
    ...
    "actionLists": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "64cd3c3c7105a169a5b597f1|f320c913-350c-7b19-e369-5f512d30a710"
                        },
                        "globalSwatchId": "",
                        "rValue": 51,
                        "bValue": 51,
                    ...
                    "config": {
                        ...
                        "target": {
                            ...
                            "selector": ".underline",
                            "selectorGuids": ["8c511929-0893-3268-7f86-9910e65decc3"]
                        },
                        "widthValue": 0,
                        "widthUnit": "px",
                        "heightUnit": "PX",
        ...
        "a-3": {
            ...
            "actionItemGroups": [{
                "actionItems": [{
                    ...
                    "config": {
                        ...
                        "duration": 500,
                        "target": {
                            "id": "64cd3c3c7105a169a5b597f1|f320c913-350c-7b19-e369-5f512d30a70c"
                        },
                        "value": 0,
                        "unit": ""
                    }
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1691262198715
        },
        "a-9": {
            "id": "a-9",
            "title": "work-link-block-hover",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-9-n",
                    "actionTypeId": "STYLE_TEXT_COLOR",
                    "config": {
                        ...
                        "target": {
                            "useEventTarget": true,
                            "id": "64cd3c3c7105a169a5b597f1|3d9c098f-84eb-17e8-945d-7d70a25e8fdf"
                        },
                        "globalSwatchId": "",
                        "rValue": 51,
                        "bValue": 51,
            ...
            "useFirstGroupAsInitialState": true,
            "createdOn": 1704460251859
        },
        "a-10": {
            "id": "a-10",
            "title": "work-link-block-hover-out",
            "actionItemGroups": [{
                "actionItems": [{
                    "id": "a-10-n",
                    "actionTypeId": "STYLE_TEXT_COLOR",
